...
import { PlaceholderLens, PlaceholderCube, PlaceholderBar } from "./PlaceholderGeometry";
...
const ModeWrapper = memo(function ModeWrapper({
  ...
  return (
    <>
      ...
      <PlaceholderComponent ref={ref} modeProps={modeProps} {...props} />
    </>
  );
});
...
function Lens({ modeProps, ...p }: { modeProps?: ModeProps } & MeshProps) {
  return (
    <ModeWrapper
      PlaceholderComponent={PlaceholderLens}
      followPointer
      modeProps={modeProps}
      {...p}
    />
...
function Cube({ modeProps, ...p }: { modeProps?: ModeProps } & MeshProps) {
  return (
    <ModeWrapper
      PlaceholderComponent={PlaceholderCube}
      followPointer
      modeProps={modeProps}
      {...p}
    />
...
function Bar({ modeProps = {}, ...p }: { modeProps?: ModeProps } & MeshProps) {
  ...
  return (
    <ModeWrapper
      PlaceholderComponent={PlaceholderBar}
      lockToBottom
      followPointer={false}
...
function Images() {
  ...
  useFrame(() => {
    ...
    group.current.children[0] && (group.current.children[0].material.zoom = 1 + data.range(0, 1 / 3) / 3);
    group.current.children[1] && (group.current.children[1].material.zoom = 1 + data.range(0, 1 / 3) / 3);
    group.current.children[2] && (group.current.children[2].material.zoom = 1 + data.range(1.15 / 3, 1 / 3) / 2);
    group.current.children[3] && (group.current.children[3].material.zoom = 1 + data.range(1.15 / 3, 1 / 3) / 2);
    group.current.children[4] && (group.current.children[4].material.zoom = 1 + data.range(1.15 / 3, 1 / 3) / 2);
  });
